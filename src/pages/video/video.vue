...
import { Videotype } from '@/@types/frontPage'
...
async function retriData(page: number) {
  const res = (await RequestApi.VideoList({ page })) as { data: Videotype[] }
  video_data.value = [...video_data.value, ...res.data]
}
  ...
  >
    <view class="video-area">
      ...
      <image
        ...
        mode="widthFix"
        @click="startPlay(index, item._id)"
      />
    </view>
